...
//   0 = None, 1 = Overview, 2 = Features, 3 = Learn&Support
  ...
  return (
    <div className='sticky top-0 flex justify-between px-10 border h-[80px]'>
      ...
      >
        <div className='px-3 border-2 py-1 border-blue-600 rounded-md text-blue-600'>
            Request a demo
        </div>
        <div className='bg-blue-600 rounded-md px-3 text-white py-1'>
            Get started free
        </div>
      </div>
